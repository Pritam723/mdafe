...
export default function FetchMeterData({ fetchBy }) {
  ...
  const fetchMeterDataInExcel = () => {
    ...
    axios("/fetchMeterDataInExcel", {
      ...
      .then((response) => {
        ...
        link.setAttribute("download", `MeterData.xlsx`);
    ...
    <div className="card">
      ...
      <span>
        <h4>
          ...
          can fetch Active/Reactive Data
          <Link
            to={
              fetchBy == "meterID"
                ? "/activeReactiveByID"
      ...
      <LoadingOverlay
        ...
        text={
          <div>
            Fetching Meter Data... <br /> You have fetched{" "}
